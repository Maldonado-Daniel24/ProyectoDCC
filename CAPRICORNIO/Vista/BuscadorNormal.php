...
<html>
<head>
    <link rel="stylesheet" href="../CSS/BuscarNormal.css">
...
<?php
  ...
  while($mostrar=mysqli_fetch_array($resultado) ){
    ...
    <td class="Cuadro2"><span class="Nombre1"><?php echo $mostrar['NOMBRE']?></span> <br><span class="Nombre2"><?php echo $mostrar['SINOPSIS']?></span> <br><span class="VerB"><?php echo "<a href='Reproduccion.php?id=".$mostrar['COD_CONTENIDO']."'>Visualizar</a>";?></span>  
